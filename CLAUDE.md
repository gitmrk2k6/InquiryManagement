...
> NestJS のデフォルトは `3000` だが、Next.js と衝突するため本プロジェクトでは `3001` 固定とする。
...
- **テーマ**: 問い合わせ管理アプリ
- **目的**: 受講生が自分でアプリを設計・実装する課題（TaskManagement と異なる技術スタックで構築）
